  ...
  <div class="sm:mx-auto sm:w-full sm:max-w-md pb-6">
    ...
    <p class="mt-2 text-center text-sm text-forest-primary max-w">
      ...
      <form id="register-section" class="space-y-6 hidden" action="#" method="POST">
        <div>
          <label for="name" class="block text-sm font-medium text-forest-txtcol">
            Full Name
          </label>
          <div class="mt-1">
        ...
        <div>
          <label for="register-email" class="block text-sm font-medium text-forest-txtcol">
            Email address
          </label>
          <div class="mt-1">
        ...
        <div>
          <label for="register-password" class="block text-sm font-medium text-forest-txtcol">
            Password
          </label>
          <div class="mt-1">
      ...
      <div class="mt-6">
        ...
        <div class="mt-6 grid grid-cols-3 gap-3">
          <div>
            <a href="#"
               class="w-full flex items-center justify-center px-8 py-3 border border-forest-secondary rounded-md shadow-sm text-sm font-medium text-forest-txtcol bg-white hover:bg-forest-tertiaryLight">
